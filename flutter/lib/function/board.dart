  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  child:ListView.separated(
                    ...
                    itemBuilder: (context, index){
                      ...
                      return Column(children: [
                        ...
                        InkWell(onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => showBoard(doc.id)));},
                        child: Container(
      ...
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => WriteBoard()));}
      ),
    );
  }
