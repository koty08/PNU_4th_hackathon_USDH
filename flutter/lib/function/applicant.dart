...
class ApplicantListBoardState extends State<ApplicantListBoard> {
                ...
                if (!snapshot.hasData) {
                  return CircularProgressIndicator();
                    ...
                    return Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                      ...
                      Text('아이콘을 누르면 게시물로 이동합니다.',
                        style: TextStyle(fontFamily: "SCDream", color: Colors.grey, fontWeight: FontWeight.w500, fontSize: 13.5)),
                      Padding(padding: EdgeInsets.fromLTRB(0, 0, 0, 10)),
                      Expanded(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  //if (doc['isFineForMembers'].length != 0) {
                                    return Column(children: [
                                      ...
                                      InkWell(
                                          onTap: () {
                                            if (doc['isFineForMembers'].length != 0 || rejectedMembers.length != 0)
                                                      ...
                                                      children: [
                                                        ...
                                                        /*if (doc['isFineForMembers'].length != 0)
                                                          ...
                                                          Container(
                                                            width: width * 0.6,
                                                            child: */
                                                        smallText('신청 : ' + doc['isFineForMembers'].length.toString() +
                                                            ',  참여 : ' + members.length.toString() +
                                                            ',  거절 : ' + rejectedMembers.length.toString() , 11, Color(0xffa9aaaf)),
                                                          //)
  ...
  Widget showBoard (String text, Widget route){
    return IconButton(
      ...
      icon: Image.asset(text, height: 30, width: 30,)
    );
  }
}
...
class ShowApplicantListState extends State<ShowApplicantList> {
                ...
                return Column(
                  children: [
                    ...
                    if(where == 'teambuild_board' || where == 'sgroup_board')...[
                      Text('아이콘을 누르면 프로필을 확인할 수 있습니다.',
                        style: TextStyle(fontFamily: "SCDream", color: Colors.grey, fontWeight: FontWeight.w500, fontSize: 13.5)),
                      Padding(padding: EdgeInsets.fromLTRB(0, 0, 0, 5)),
                    ],
                    Text('[요청중] 을 누르면 승인/거절할 수 있습니다.',
                      style: TextStyle(fontFamily: "SCDream", color: Colors.grey, fontWeight: FontWeight.w500, fontSize: 13.5)),
                    Padding(padding: EdgeInsets.fromLTRB(0, 0, 0, 10)),
                    Expanded(
                      child: MediaQuery.removePadding(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            if(hasrejected){
                              if(rejectedMembers.contains(allMembers[index]))
                                wassrejected = true;
                            }
                            if(members.length!=0){
                              if(members.contains(allMembers[index]))
                                ismember = true;
                            }
                            return Column(children: [
                              Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      if(!wassrejected) ...[
                                        ...
                                        if(where != 'teambuild_board' && where != 'sgroup_board')
                                          Image(image: AssetImage('assets/images/icon/profile.png'), width: 18, height: 18),
  ...
  void select(AsyncSnapshot<DocumentSnapshot> snapshot, int index, String where, List<dynamic> members){
    ...
    final list2 = ['assets/images/icon/pleadingapple.png', 'assets/images/icon/pleadinggoogle.png', 'assets/images/icon/pleadingtwitter.png',];
              ...
              children: [
                Column(
                  children: [
                    ...
                    Text(text,
                        style: TextStyle(fontFamily: "SCDream", color: Colors.black54, fontWeight: FontWeight.w500, fontSize: 18)),
